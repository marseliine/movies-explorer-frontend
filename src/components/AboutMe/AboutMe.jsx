		...
		<section className="about-me">
			...
			<article className="portfolio">
				...
				<ul className="portfolio__list">
					...
					<li className="portfolio__item">
						<Link to="https://marseliine/russian-travel/index.html" target='_blank' className="link portfolio__link">Адаптивный сайт</Link>
					</li>
					<li className="portfolio__item">
						<Link to="https://github.com/marsliine/react-mesto-api-full-gha" target='_blank' className="link portfolio__link">Одностраничное приложение</Link>
					</li>
				</ul>
			</article>
		</section>
