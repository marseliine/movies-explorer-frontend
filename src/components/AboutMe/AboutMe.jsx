  ...
  return (
    <section id={'about-me'} className={'about-me'}>
      ...
      <div className={'about-me__wrapper'}>
        <p className={'about-me__name'}>Екатерина</p>
        <p className={'about-me__job'}>Фронтенд-разработчик, 22 года</p>
        <p className={'about-me__description'}>
          Приветствую! Меня зовут Екатерина, и я живу в Москве. Я начала
          увлекаться программированием и веб-разработкой, решила развивать свои
